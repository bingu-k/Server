...
namespace DummyClient
{
    ...
    class ServerSession : Session
    {
        public override void OnConnected(EndPoint endPoint)
        {
            ...
            PlayerInfoReq packet = new PlayerInfoReq() { playerId = 1001, name = "asfd" };
            ...
            packet.skills.Add(new PlayerInfoReq.Skill() { id = 201, level = 2, duration = 4.2f });
            packet.skills.Add(new PlayerInfoReq.Skill() { id = 301, level = 3, duration = 5.3f });
            packet.skills.Add(new PlayerInfoReq.Skill() { id = 401, level = 4, duration = 6.4f });
